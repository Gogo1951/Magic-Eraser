...
L["OPTIONS_DESC"] = "Magic Eraser는 인벤토리에서 가장 가치가 낮은 잡동사니를 식별하고 미니맵 버튼을 한 번 클릭하여 삭제합니다. 완료된 퀘스트 아이템, 저레벨 소모품, 상인 품질의 흰색 아이템 및 회색 잡동사니를 모두 지워줍니다. 상인을 방문하면 자동 판매가 나머지 아이템을 자동으로 판매합니다."
