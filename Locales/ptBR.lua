...
L["TAB_SAFETY"] = "Recursos de segurança"
...
L["TAB_SAFETY_DESCRIPTION"] =
	"Quase todo item que você exclui pode ser recuperado pelo serviço de restauração de itens da Blizzard, então um erro aqui raramente é permanente. Ainda assim vale a pena olhar estas configurações: é aqui que você decide o quanto o Magic Eraser é cauteloso e o quanto ele te avisa pelo caminho."
...
L["OPTIONS_MANUAL_DELETE_NO_VALUE"] = "Sem valor de venda"

-- Mini-map Eraser Confirmation
L["OPTIONS_SAFETY_HEADER"] = "Confirmação de exclusão pelo minimapa"
L["OPTIONS_SAFETY_DESCRIPTION"] = "Perguntar antes de excluir os tipos de item marcados abaixo."
L["OPTIONS_ENABLE_SAFETY"] = "Ativar confirmação de exclusão pelo minimapa"
L["OPTIONS_SAFETY_QUEST"] = "Para itens de missões concluídas"
L["OPTIONS_SAFETY_CONSUMABLE"] = "Para consumíveis que você já superou"
L["OPTIONS_SAFETY_WHITE"] = "Para itens brancos de qualidade de vendedor"
L["OPTIONS_SAFETY_GRAY"] = "Para lixo de vendedor cinza"
