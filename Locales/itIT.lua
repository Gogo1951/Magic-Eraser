...
L["CHAT_LOADED"] = "Versione @project-version@. Le impostazioni si trovano in Opzioni > AddOn > Magic Eraser, inclusa la disattivazione di questo messaggio. Ti piace Magic Eraser? Dillo a un amico! (="
