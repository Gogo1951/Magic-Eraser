...
local tbcItems = {
    ...
    -- [34828] = true, -- Antique Silver Cufflinks
    [20895] = true, -- Apprentice's Boots
    ...
    [23351] = true, -- Battleworn Shirt
    [23349] = true, -- Battleworn Shoes
    [29014] = true, -- Blacksteel Throwing Dagger
    [23909] = true, -- Blood Elf Bandit Mask
    [27982] = true, -- Charm of Potent and Powerful Passions
    [27941] = true, -- Compassionate Critter's Friend
    ...
    [33014] = true, -- Fine Poking Stick
    [30760] = true, -- Formal Draenic Robe
    [25876] = true, -- Gleaming Throwing Axe
    [38091] = true, -- Gold Eternium Band
    -- [34826] = true, -- Gold Wedding Band
    [34087] = true, -- Green Winter Clothes
    ...
    [34249] = true, -- Hula Girl Doll
    [27992] = true, -- Infallible Tikbalang Ward
    ...
    [27940] = true, -- Marvelous Madstone of Immortality
    [25877] = true, -- Master's Throwing Dagger
    [20913] = true, -- Medium Guard
    [20981] = true, -- Neophyte's Mace
    [37934] = true, -- Noble's Elementium Signet
    -- [34827] = true, -- Noble's Monocle
    -- [34829] = true, -- Ornate Drinking Stein
    [27976] = true, -- Polished Pendant of Edible Energy
    -- [34626] = true, -- Prototype Tonk Controller
    [34859] = true, -- Razor Sharp Fillet Knife
    [23475] = true, -- Recruit's Boots
    [23473] = true, -- Recruit's Shirt
    [20977] = true, -- Recruit's Shortsword
    [34085] = true, -- Red Winter Clothes
    [38089] = true, -- Ruby Shades
    [23472] = true, -- Rugged Trapper's Boots
    [23470] = true, -- Rugged Trapper's Shirt
    [38090] = true, -- Sapphire Pinky Ring
    [23348] = true, -- Scout's Boots
    [23345] = true, -- Scout's Shirt
    [23212] = true, -- Scrapper's Vest
    [27945] = true, -- Shark's Tooth of Bona Fide Fluidic Mobility
    [20982] = true, -- Sharp Dagger
    [29008] = true, -- Sharp Throwing Axe
    [27978] = true, -- Soap on a Rope
    [23476] = true, -- Squire's Shirt
    [20910] = true, -- Stiff Shortbow
    [27979] = true, -- Stone of Stupendous Springing Strides
    ...
    [27944] = true, -- Talisman of True Treasure Tracking
    [33012] = true, -- Terokkar Lilac
